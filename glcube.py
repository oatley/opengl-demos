...
@window.event
def on_draw():
   global dx, dy, d, thrustd, thrustx, thrusty, window, key_handler, d
   l = 0.5 * window.width
   ...
   draw_square_top(l=thrustd, color=[1.0, 0.0, 0.0])
   draw_square_top(l=-thrustd, color=[1.0, 0.0, 0.0])
   draw_square_front(l=thrustd, color=[0.0, 1.0, 0.0])
   draw_square_front(l=-thrustd, color=[0.0, 1.0, 0.0])
   draw_square_right(l=thrustd, color=[0.0, 0.0, 1.0])
   draw_square_right(l=-thrustd, color=[0.0, 0.0, 1.0])
